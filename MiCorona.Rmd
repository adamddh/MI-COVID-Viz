...
Note that the last `r day_split-1`-`r day_split+1` days of data have been colored red on the graph, as they frequently change as more information becomes available. 