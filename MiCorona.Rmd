...
Note that the last `r length(unique(mi_cases_by_day_last4$Date))` days of data have been colored red on the graph, as they frequently change as more information becomes available. Vertical line at 3 weeks in the past (as hospitalizations usually follow cases by three weeks).
