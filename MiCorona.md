...
``` r
download.file("https://www.michigan.gov/documents/coronavirus/Cases_and_Deaths_by_County_and_Date_2020-10-17_705376_7.xlsx", destfile = "/tmp/file.xlsx")
...
Note that the last 2-3 days of data have been colored red on the graph,
